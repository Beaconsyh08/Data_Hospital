...
class QaCam3dTempManager(DataManager):
    """
    Summary
    -------
    ...
    def __init__(self, df: pd.DataFrame = None, df_path: str = None, cfg: dict = None) -> None:
        super(QaCam3dTempManager, self).__init__(df, df_path, cfg)
        ...
        for obj in obj_lst:
            ...
            if case_flag in ["0", "21", "22"]:
                ...
                try:
                    ...
                    pass
                try:
                    if gt_info["dis_ratio"] <= 0.12 or gt_info["euclidean_dis_diff"] <= 0.3:
                        gt_info["flag"] = "good"
