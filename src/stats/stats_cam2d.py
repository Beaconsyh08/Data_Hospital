...
class StatsCam2D(BaseStats):
    ...
    def overall_metric(self, ):
        ...
        # self.indicator_panel['P0_Precision'] = metric_dic['P0']['Precision']
        # self.indicator_panel['P0_Recall'] = metric_dic['P0']['Recall']
        # self.indicator_panel['P0_F1_Score'] = metric_dic['P0']['F1_Score']
    ...
    def error_analysis(self, ):
        ...
        gt_dt_info = dict()
        for row in tqdm(self.df.itertuples(), total=len(self.df)):
            index, flag, class_name,x,y,w,h,dt_bbox = row.Index, row.flag, row.class_name,\
                                                      row.bbox_x, row.bbox_y, row.bbox_w, \
                                                      row.bbox_h, row.dt_bbox 
    ...
    def compare_multi_version(self, show=True):
        ...
        # for key, value in self.qa_base_df.multi_version_info.value_counts().to_dict().items():
        ...
        self.indicator_panel['P0_miss'] =  self.qa_base_df[(self.qa_base_df['priority'] == 'P0') & (self.qa_base_df['flag'] == 'miss')].shape[0]
        self.indicator_panel['P0_false'] =  self.qa_base_df[(self.qa_base_df['priority'] == 'P0') & (self.qa_base_df['flag'] == 'false')].shape[0]
        ...
        if show:
            for row in tqdm(df_multi_comp.itertuples(), total=len(df_multi_comp)):
                ...
                save_path = os.path.join('/cpfs/output/other/', multi_version, \
...
if __name__ == '__main__':
    ...
    # temp_stat = StatsCam2D(df=temp_dm.df, df_path = '/share/analysis/cmh/result/dataframes/combine_dataframe.pkl',\
    #                      emb_path='/share/analysis/cmh/result/embedding/feas_moco_512_l2.npy')
