...
oss_urls = []
json_path = '/root/data_hospital_data/yayun_night_new/coor_trans_doctor/trans/' # json_files文件夹下保存了所有用于创建卡片的json文件，里面的json文件不在oss上，使用时修改此地址即可
...
card_id = card_inst.create_card_w_append( project='icu30', media_name='yayun', target_dir=json_path) # 设置生成卡片的 project 和 media_name
