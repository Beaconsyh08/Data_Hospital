...
INF_MODEL = "/share/analysis/syh/models/C2_BASE20+FN10.pth"
...
class Config:
    ...
    ROOT = '/root/data_hospital_data/%s/%s' % (MODEL_NAME, NAME)
...
class DataHospitalConfig(Config):
    ...
    INF_MODELS = ['/share/analysis/syh/models/BASE20+FN2.pth', '/share/analysis/syh/models/BASE20+RN2.pth']
